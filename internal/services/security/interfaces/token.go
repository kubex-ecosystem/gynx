...
type TokenService interface {
	NewPairFromUser(ctx context.Context, u *userstore.Users, prevTokenID string) (*TokenPair, error)
	SignOut(ctx context.Context, uid string) error
	ValidateIDToken(tokenString string) (*userstore.Users, error)
