// Package middleware implements a simple circuit breaker pattern
package middleware
...
func (cb *CircuitBreaker) Allow() error {
	...
	case CircuitOpen:
		...
		return gl.Serrorf("circuit breaker is OPEN, request blocked")

	case CircuitHalfOpen:
		return nil // Allow limited requests in half-open state

	default:
		return gl.Serrorf("unknown circuit breaker state")
	}
}
