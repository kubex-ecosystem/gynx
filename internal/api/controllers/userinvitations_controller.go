...
func NewUserInvitationsController(service svc.Service[mdl.UserInvitations]) Controller[mdl.UserInvitations] {
	return NewController[mdl.UserInvitations](nil, service)
}
...
// 			c.JSON(http.StatusNotFound, gin.H{"error": "UserInvitations not found"})
// 			return
// 		}
// 		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
// 		return
...
// 	var payload mdl.UserInvitations
