...
type TrainingBadgesController struct {
	service svc.Service[mdl.TrainingBadges]
}

func NewTrainingBadgesController(service svc.Service[mdl.TrainingBadges]) Controller[mdl.TrainingBadges] {
...
// 		// 	c.JSON(http.StatusNotFound, gin.H{"error": "TrainingBadges not found"})
// 		// 	return
// 		// }
// 		c.JSON(http.StatusInternalServerError, gin.H{"error": err.Error()})
// 		return
...
// 	var payload mdl.TrainingBadges
